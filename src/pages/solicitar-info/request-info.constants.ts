// Configuración del header de la página de solicitud de info
export const HEADER_CONFIG = {
  title: "Solicitá información",
  subtitle: "Completá el formulario para solicitar información personalizada sobre alguno de nuestros productos, cotizaciones o consultas generales. Nuestro equipo se pondrá en contacto con vos a la brevedad para brindarte toda la información que necesites."
}

// Configuración del formulario de solicitud de info
